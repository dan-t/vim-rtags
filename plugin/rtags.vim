...
if g:rtagsUseDefaultMappings == 1
    ...
    autocmd FileType cpp nnoremap <Leader>rJ :call rtags#JumpTo(g:SAME_WINDOW, { '--declaration-only' : '' })<CR>
    autocmd FileType cpp nnoremap <Leader>rS :call rtags#JumpTo(g:H_SPLIT)<CR>
    autocmd FileType cpp nnoremap <Leader>rV :call rtags#JumpTo(g:V_SPLIT)<CR>
    autocmd FileType cpp nnoremap <Leader>rT :call rtags#JumpTo(g:NEW_TAB)<CR>
    autocmd FileType cpp nnoremap <Leader>rp :call rtags#JumpToParent()<CR>
    autocmd FileType cpp nnoremap <Leader>rf :call rtags#FindRefs()<CR>
    autocmd FileType cpp nnoremap <Leader>rn :call rtags#FindRefsByName(input("Pattern? ", "", "customlist,rtags#CompleteSymbols"))<CR>
    autocmd FileType cpp nnoremap <Leader>rs :call rtags#FindSymbols(input("Pattern? ", "", "customlist,rtags#CompleteSymbols"))<CR>
    autocmd FileType cpp nnoremap <Leader>rr :call rtags#ReindexFile()<CR>
    autocmd FileType cpp nnoremap <Leader>rl :call rtags#ProjectList()<CR>
    autocmd FileType cpp nnoremap <Leader>rw :call rtags#RenameSymbolUnderCursor()<CR>
    autocmd FileType cpp nnoremap <Leader>rv :call rtags#FindVirtuals()<CR>
    autocmd FileType cpp nnoremap <Leader>rb :call rtags#JumpBack()<CR>
...
function! RtagsCompleteFunc(findstart, base)
    ...
    if a:findstart
        ...
        let a = []
        let types = ["CXXMethod", "CXXDestructor", "FieldDecl", "VarDecl", "EnumConstantDecl", "ClassDecl", "FunctionTemplate"]
